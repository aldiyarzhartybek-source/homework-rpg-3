...
public final class DragonBoss implements Enemy {
    ...
    public DragonBoss(String name, String element, int health, int damage, int defense, int speed,
    ...
    @Override public String getType() { return element + " Dragon"; }
    ...
    @Override public Enemy copy() { return new DragonBoss(this); }
}
